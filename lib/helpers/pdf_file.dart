...
pw.Widget _buildRemarks({pw.TextStyle? style}) {
  return pw.Column(
    ...
    children: [
      pw.Text(
        '※1・・・05:00～22:00の間に働いた時間です。「通常時間」が8時間を超えた場合は、08:00と表示し、過ぎた分は「通常時間外」に表示します。',
        style: style,
      ),
      pw.Text(
        '※2・・・22:00～05:00の間に働いた時間です。「深夜時間」が8時間を超えた場合は、08:00と表示し、過ぎた分は「深夜時間外」に表示します。',
        style: style,
      ),
      pw.Text(
        '※3・・・勤務時間外を計算し、深夜時間帯に働いてなければ、通常時間外とする。',
        style: style,
      ),
      pw.Text(
        '※4・・・勤務時間外を計算し、深夜時間帯に働いていれば、深夜時間外とする。',
        style: style,
      ),
      pw.Text(
        '※5・・・日〜土曜日までの総勤務時間です。',
