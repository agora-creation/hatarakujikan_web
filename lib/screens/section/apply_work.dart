...
class SectionApplyWorkScreen extends StatelessWidget {
  static const String id = 'section_applyWork';
...
class SectionApplyWorkTable extends StatefulWidget {
  final ApplyWorkProvider applyWorkProvider;
  final SectionProvider sectionProvider;

  SectionApplyWorkTable({
    @required this.applyWorkProvider,
    @required this.sectionProvider,
  });

  @override
  _SectionApplyWorkTableState createState() => _SectionApplyWorkTableState();
}

class _SectionApplyWorkTableState extends State<SectionApplyWorkTable> {
  UserModel user;
  bool approval = false;
